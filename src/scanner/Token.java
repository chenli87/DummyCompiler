...
public class Token {
	public enum Type {
		ID, NUM, EQ, NEQ, LT, LE, GT, GE, LET, CALL, IF, THEN, ELSE, FI, WHILE, DO, OD, RETURN, VAR, ARRAY, FUNCTION, PROCEDURE, MAIN, LPAREN, RPAREN, LSB, RSB, LCB, RCB, TIMES, DIVIDE, PLUS, MINUS, ASSIGN, COMMA, SCOLON, DOT, EOF, ERROR   
	}
